...
const { placeOrder, verifyOrder, webhookHandler, adminListOrders, userListOrders, deleteOrder, updateOrderStatus, confirmOrderDelivered, adminGetOrder } = require('../controllers/orderController')
...
orderRouter.get("/admin-order/:id",authMiddleware,requireRole("admin"),adminGetOrder)
